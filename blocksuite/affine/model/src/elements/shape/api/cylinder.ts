...
export const cylinder = {
  ...
  includesPoint(
    ...
    const points = getPointsFromBoundWithRotation(this, cylinder.points);
  ...
  containsBound(bounds: Bound, element: ShapeElementModel) {
    const points = getPointsFromBoundWithRotation(element, cylinder.points);
  ...
  getRelativePointLocation(position: IVec, element: ShapeElementModel) {
    ...
    let points = cylinder.points(bound);
    points.push(point);
